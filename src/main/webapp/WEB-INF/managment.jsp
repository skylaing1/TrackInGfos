            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3" style="background: var(--bs-card-bg);">
                        ...
                        <div class="btn-group float-end" role="group"><button class="btn btn-primary pull-right" type="button" style="margin-right: 20px;background: var(--bs-primary);"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 24 24" width="1em" fill="currentColor" style="font-size: 24px;">
                        ...
                        <div id="dataTable-1" class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                            <table id="dataTable" class="table table-hover my-0" style="white-space: nowrap;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Airi Satou
                                    </td>
                                    <td>Accountant</td>
                                    <td>Tokyo</td>
                                    <td>33</td>
                                    ...
                                    <td>$162,700</td>
                                    <td>
                                        <i class="far fa-eye iconeye iconeye"></i>
                                        <i class="far fa-edit iconedit"></i>
                                        <i class="far fa-trash-alt icontrash"></i>
                                    </td>
                                </tr>
                                <tr>
                                    <td><input class="row-checkbox large-checkbox" type="checkbox" /></td>
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Angelica Ramos
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Ashton Cox
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Bradley Greer
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Brenden Wagner
                                    </td>
                                    <td>Software Engineer</td>
                                    <td>San Francisco</td>
                                    <td>28</td>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Brielle Williamson
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Bruno Nash<br />
                                    </td>
                                    <td>Software Engineer</td>
                                    <td>London</td>
                                    <td>38</td>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Caesar Vance
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Cara Stevens
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                        <div class="c-avatar"><img class="rounded-circle me-2" height="30" src="../resources/img/avatars/avatar1.jpeg" width="30" /><span class="c-avatar__status"></span></div>Cedric Kelly
                                    </td>
