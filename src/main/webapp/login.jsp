...
<body class="bg-gradient-primary" style="background: url(&quot;img/background/pexels-photo-6985128.jpeg&quot;) top / cover no-repeat;">
<div class="container">
                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-flex">
                            <div class="flex-grow-1 bg-login-image" style="background: url(&quot;img/Mobilelogin-rafiki.png&quot) center / contain no-repeat, var(--bs-purple);"></div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                               ...
                               <!-- <div class="text-center"><a class="small" href="forgot-password.html">Passwort vergessen?</a></div> TODO: Passwort vergessen -->
                                <div class="text-center"><a class="small" href="register.jsp">Erstellen sie einen Benutzer!</a></div>
                            </div>
                        </div>
                    </div>
                </div>
